...
const faqs = [
  {
    q: "영어를 못해도 되나요?",
    a: <>네 걱정하지 않으셔도 됩니다.<br /><KelloText />가 AI 실시간 번역으로 외국인 고객과의 소통을 지원합니다. 예약 접수부터 상담까지 사장님은 한국어로만 응대하시면 됩니다.</>,
  },
  {
    q: "노쇼가 걱정돼요.",
    a: <><KelloText />는 100% 선결제·정찰제 기반입니다. 고객이 예약 시 결제를 완료하기 때문에 노쇼 리스크가 사실상 제로입니다. 확정된 매출만 받으세요.</>,
  },
  {
    q: "수수료는 어떻게 되나요?",
  ...
  },
  {
    ...
    a: <><KelloText />는 외국인 전용 예약 채널로 운영되므로, 기존에 사용 중인 국내 예약 시스템과 독립적으로 운영됩니다. Kello의 확실한 예약관리로 걱정없이 사용하실 수 있습니다.</>,
  },
];
